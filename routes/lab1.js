...
router.get('/orders', authenticate, authorize('admin', 'receptionist', 'doctor', 'nurse', 'pharmacist'), async (req, res) => {
...
router.get('/orders/:id', authenticate, authorize('admin', 'receptionist', 'doctor', 'nurse', 'pharmacist'), async (req, res) => {
  try {
